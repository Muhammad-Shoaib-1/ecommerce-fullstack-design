...
const seedDB = async () => {
  ...
  const coupons = [
    { code: 'SAVE10',  type: 'percent', value: 10, minOrderAmount: 0,   maxDiscount: 50,   description: '10% off your order' },
    { code: 'SAVE20',  type: 'percent', value: 20, minOrderAmount: 100, maxDiscount: 100,  description: '20% off orders over $100' },
    { code: 'FLAT15',  type: 'flat',    value: 15, minOrderAmount: 50,  description: '$15 off orders over $50' },
    { code: 'WELCOME', type: 'percent', value: 15, minOrderAmount: 0,   maxDiscount: 30,   perUserLimit: 1, description: 'Welcome discount — first order only' },
  ]
  ...
  console.log(`   Coupons    : ${coupons.length} (SAVE10, SAVE20, FLAT15, WELCOME)`)
